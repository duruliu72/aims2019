              ...
              <div class="panel-body">
                <form action="{{URL::to('shift')}}/{{$bean->id}}" method="POST">
                  ...
                  <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input id="startTime" type="text" class="form-control" name="startTime" value="{{$bean->startTime}}">
                      </div>
                      <label class="control-label col-sm-2" for="endTime">To</label>
                      <div class="col-sm-4">
                        <input id="endTime" type="text" class="form-control" name="endTime" value="{{$bean->endTime}}">
                      </div>
                  </div>
                  <div class="form-group row">
