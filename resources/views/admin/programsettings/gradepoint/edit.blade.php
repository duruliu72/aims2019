                  ...
                  <div class="row">
                    <div class="col-md-12 courseoffer">
                          ...
                          @foreach($gradeList as $x)
                            @if($x->gradeletterid!=0)
                              <tr>
                                ...
                                <td><div class="form-group"><input class="form-control" type="text" name="from_mark[{{$x->id}}]" value="{{$x->from_mark}}" /></div></td>
                                <td><div class="form-group"><input class="form-control" type="text" name="to_mark[{{$x->id}}]" value="{{$x->to_mark}}" /></div></td>
                                <td><div class="form-group"><input class="form-control" type="text" name="gradepoint[{{$x->id}}]" value="{{$x->gradepoint}}" /></div></td>
                     ...
                     <div class="row">
                      <div class="col-sm-12">
                        <div class="btn-container">
                          <button type="submit" class="btn btn-success result-btn" name="edit_btn" value="edit_btn">Update</button>
                          <a class="btn btn-info refresh-btn" href="{{URL::to('gradepoint')}}/{{'edit'}}"><i class="ace-icon fa fa-refresh bigger-120"></i>Refresh</a>
                        </div>
                      </div>
                    </div>
                  </form>
