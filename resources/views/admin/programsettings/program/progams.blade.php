                ...
                <form action="{{URL::to('program')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div>
                                @foreach($groupList1 as $pl)
                                    <label style="margin-right:10px;" for="groupid[{{$pl->id}}]"><input class="form-check-input" type="checkbox" name="groupid[{{$pl->id}}]" value="{{$pl->id}}" id="groupid[{{$pl->id}}]">{{$pl->name}}</label>
                                @endforeach
                            </div>
                        </div>
                    </div>
