  ...
  <section class="wrapper">
    <div class="row">
      ...
      <h3 class="page-header"><i class="fa fa-laptop"></i>{{$institute->name}}</h3>
        <ol class="breadcrumb">
           @if($pList[2]->id==2)
          <li><a href="{{URL::to('/permission')}}/{{'create'}}">New</a></li>
          @endif
          <li>Permission</li>
        </ol>
      </div>
      ...
      <div class="col-lg-12">
        <section class="panel">
          <div class="table-responsive">
           <table id="tableid1" class="table table-striped table-bordered nowrap" style="width:100%">
            <thead>
              <tr>
                <th>SL NO</th>
                <th>Name</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                @if($pList[3]->id==3)
                <td> 
                  <a href="{{URL::to('/permission')}}/{{$x->id}}/{{'edit'}}" class="tooltip-success" data-rel="tooltip" title="Edit">
                    <span class="green">
