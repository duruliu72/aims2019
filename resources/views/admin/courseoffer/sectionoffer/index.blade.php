  ...
  <section class="wrapper">
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          @if($pList[2]->id==2)
            <li><a href="{{URL::to('/sectionoffer')}}/{{'create'}}">New</a></li>
          @endif
          <li>Section Offer</li>
        </ol>
      </div>
           ...
           <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                <td>{{++$id}}</td>
                <td>{{$x->className}}</td>
                <td>{{$x->sectiondetails}}</td>
                @if($pList[3]->id==3)
                <td> 
                  <a href="{{URL::to('/sectionoffer')}}/{{$x->id}}/{{'edit'}}" class="tooltip-success" data-rel="tooltip" title="Edit">
                    <span class="green">
