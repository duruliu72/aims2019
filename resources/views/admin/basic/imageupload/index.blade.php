  ...
  <section class="wrapper">
    <div class="row">
      <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
          @if($pList[2]->id==2)
            <li><a href="{{URL::to('/imageupload')}}/{{'create'}}">New</a></li>
          @endif
          <li>Image Upload</li>
        </ol>
      </div>
           ...
           <table id="example" class="table table-striped table-bordered nowrap" style="width:100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                @if($pList[3]->id==3)
                <td> 
                  <a href="{{URL::to('/imageupload')}}/{{$x->id}}/{{'edit'}}" class="tooltip-success" data-rel="tooltip" title="Edit">
                    <span class="green">
                ...
                @if($pList[4]->id==4)
                <td>
                  <a href="{{URL::to('/imageupload')}}/{{$x->id}}" class="tooltip-error" data-rel="tooltip" title="Delete">
                    <span class="red">
