        ...
        <ul class="nav pull-right top-menu">
          ...
          <li id="mail_notificatoin_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('clientAdmin./img/avatar-mini.jpg')}}"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('clientAdmin/img/avatar-mini2.jpg')}}"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('clientAdmin/img/avatar-mini3.jpg')}}"></span>
                                    <span class="subject">
              ...
              <li>
                <a href="#">
                                    <span class="photo"><img alt="avatar" src="{{asset('clientAdmin/img/avatar-mini4.jpg')}}"></span>
                                    <span class="subject">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="{{asset('clientAdmin/img/avatar1_small.jpg')}}">
                            </span>
